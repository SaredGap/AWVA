...
<body>
    ...
    <div class="container mt-5">
        ...
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#crearUsuarioModal">Crear
            Usuario</button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="<?= site_url('Admin/Dashboard/editar_usuario/' . $usuario['id']) ?>"
                                                    method="post">
                                                    <!-- Campos de edición -->
